...
def run_sequence(seq: Sequence, tracker: Tracker, debug=False, num_gpu=8, dte=False):
...
def run_dataset(dataset, trackers, debug=False, threads=0, num_gpus=8, dte=False):
    ...
    if mode == 'sequential':
        for seq in dataset:
            for tracker_info in trackers:
                run_sequence(seq, tracker_info, debug=debug, dte=dte)
    elif mode == 'parallel':
