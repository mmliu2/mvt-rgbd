...
def main():
    ...
    parser = argparse.ArgumentParser(description='Convert log file to depthtrack metrics.')
    parser.add_argument('--log_file', type=str, default='mobilevit_track_det-mvtdet_256_128x1_depthtrack.log')
    parser.add_argument('--output_file', type=str, default='full_det.png')
    
    args = parser.parse_args()

    log_path = os.path.join('output/logs/', args.log_file)
    output_path = os.path.join('plotting/figs/', args.output_file)
